...
const THINKER_PERSONAS = {
  sartre: {
    ...
    core_beliefs: [
      ...
      "Bad faith is the primary moral failure",
    ],
  ...
  nietzsche: {
    ...
    core_beliefs: [
      "Morality is a construct of power",
      "The will to power drives all",
      "Ressentiment poisons values",
    ],
  ...
  camus: {
    ...
    core_beliefs: [
      "Life is absurd but we must imagine Sisyphus happy",
      "Revolt is the appropriate response",
      "Solidarity binds us in shared struggle",
    ],
  ...
  dostoevsky: {
    ...
    core_beliefs: [
      "Suffering has redemptive potential",
      "Conscience cannot be silenced",
      "Freedom includes the freedom to suffer",
    ],
  ...
  emerson: {
    ...
    core_beliefs: [
      "Trust thyself",
      "Society is in conspiracy against self-reliance",
      "Nature reflects the oversoul",
    ],
  ...
  burroughs: {
    ...
    core_beliefs: [
      ...
      "Control systems must be dismantled",
      "The Word is a virus",
    ],
  ...
  rawls: {
    ...
    typical_opener:
      "Imagine we are behind a veil of ignorance, not knowing our place in society...",
  },
  campbell: {
    voice: "Mythologist and spiritual guide",
    speaking_style: "Sweeping, encyclopedic, connecting ancient myths to modern life",
    core_beliefs: [
      "The hero journey underlies all stories",
      "Follow your bliss",
      "Myth is living truth",
    ],
    typical_opener:
...
async function inner_dialogue(params) {
  const { question, participants = [], max_exchanges = 6 } = params;
 ...
 */
function getExchangeFocus(round, exchangeNumber) {
  const focuses = [
