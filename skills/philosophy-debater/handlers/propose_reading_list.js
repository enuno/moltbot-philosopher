...
const READING_DATABASE = {
  sartre: {
    beginner: [
      {
        ...
        focus: "Introduction to freedom and responsibility",
        type: "essay",
      },
    ...
    intermediate: [
      {
        work: "Being and Nothingness (Part I)",
        focus: "Bad faith and authenticity",
        type: "treatise",
      },
    ...
    advanced: [
      {
        ...
        focus: "Complete phenomenological ontology",
        type: "treatise",
      },
      {
        work: "Critique of Dialectical Reason",
        focus: "Social philosophy and group praxis",
        type: "treatise",
      },
    ],
  },
  nietzsche: {
    beginner: [
      ...
      {
        work: "The Gay Science (selected aphorisms)",
        focus: "Life affirmation",
        type: "aphorisms",
      },
    ],
    intermediate: [
      {
        ...
        focus: "Critique of philosophical prejudice",
        type: "treatise",
      },
      {
        work: "Thus Spoke Zarathustra (Parts I-II)",
        focus: "Self-overcoming and eternal recurrence",
        type: "narrative",
      },
    ],
    advanced: [
  ...
  dostoevsky: {
    ...
    intermediate: [
      ...
      {
        work: "The Brothers Karamazov (selected chapters)",
        focus: "The Grand Inquisitor",
        type: "novel",
      },
    ],
    advanced: [
      {
        ...
        focus: "Faith, doubt, and moral responsibility",
        type: "novel",
      },
  ...
  emerson: {
    ...
    advanced: [
      {
        work: "Essays: First and Second Series",
        focus: "Complete early philosophy",
        type: "collection",
      },
  ...
  jefferson: {
    beginner: [
      ...
      {
        work: "Selected Letters on Education",
        focus: "Democratic citizenship",
        type: "correspondence",
      },
    ],
    intermediate: [
      {
        work: "Notes on the State of Virginia",
        focus: "Republican virtue and agrarianism",
        type: "treatise",
      },
    ...
    advanced: [
      {
        work: "The Jefferson Papers (selected)",
        focus: "Political philosophy in practice",
        type: "collection",
      },
      {
        work: "Correspondence with Adams",
        focus: "Natural aristocracy and equality",
        type: "correspondence",
      },
    ],
  },
...
async function propose_reading_list(params) {
  const { topic, experience_level = "beginner", max_items = 6 } = params;
