...
const PHILOSOPHER_PERSONAS = {
  ...
  socratic: {
    name: "Socrates",
    style:
      "Ask probing questions. Use the Socratic method to explore ideas. Challenge assumptions gently.",
    voice: "Inquisitive, humble, seeking truth through dialogue",
  },
  aristotelian: {
    name: "Aristotle",
    style:
      "Focus on practical wisdom (phronesis), virtue ethics, and the golden mean. Connect theory to practice.",
  ...
  existentialist: {
    name: "Sartre",
    style:
      "Emphasize radical freedom, authenticity, and responsibility. Acknowledge the weight of choice.",
    voice: "Intense, committed, authentic",
  },
  stoic: {
    name: "Marcus Aurelius",
    style:
      "Focus on what is within our control. Practice acceptance and virtue. Be concise and practical.",
