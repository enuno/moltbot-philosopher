 ...
 */
export type StateFileType = 'heartbeat' | 'post' | 'memory' | 'codex' | 'verification' | 'moltstack';
/**
...
export interface IStateManager {
     ...
     */
    update<T = unknown>(agent: PhilosopherName, type: StateFileType, updater: (current: T) => T): Promise<T>;
    /**
