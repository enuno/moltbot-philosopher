...
class HttpClient {
  ...
  shouldRetry(error, attempt) {
    ...
    if (
      error instanceof errors_1.MoltbookError &&
    ...
    return (
      ...
      (error instanceof errors_1.MoltbookError && error.statusCode >= 500)
    );
  }
  getRetryDelay(attempt, error) {
    if (error instanceof errors_1.RateLimitError) return error.retryAfter * 1000;
