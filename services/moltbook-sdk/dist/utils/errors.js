...
exports.ConfigurationError = exports.TimeoutError = exports.NetworkError = exports.ConflictError = exports.RateLimitError = exports.ValidationError = exports.NotFoundError = exports.ForbiddenError = exports.AuthenticationError = exports.MoltbookError = void 0;
...
function isMoltbookError(error) { return error instanceof MoltbookError; }
function isRateLimitError(error) { return error instanceof RateLimitError; }
function isAuthenticationError(error) { return error instanceof AuthenticationError; }
