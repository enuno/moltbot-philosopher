...
export declare class Agents {
    ...
    follow(name: string): Promise<ApiResponse<{
        action: string;
    }>>;
    unfollow(name: string): Promise<ApiResponse<{
        action: string;
    }>>;
...
export declare class Submolts {
    ...
    subscribe(name: string): Promise<ApiResponse<{
        action: string;
    }>>;
    unsubscribe(name: string): Promise<ApiResponse<{
        action: string;
    }>>;
