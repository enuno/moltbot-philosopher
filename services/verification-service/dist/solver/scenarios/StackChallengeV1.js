...
exports.validateStackChallengeV1 = validateStackChallengeV1;
/**
 ...
 */
function validateStackChallengeV1(answer) {
  const reasons = [];
  ...
  if (sentences[0]) {
    ...
    const hasToolMention =
      /(tool|api|plugin|system|external|no tool|not using|without|don't use)/.test(s1);
    if (!hasToolMention) {
      reasons.push("Sentence 1 must state belief about tool/API/plugin usage");
    }
  } else {
...
//# sourceMappingURL=StackChallengeV1.js.map
