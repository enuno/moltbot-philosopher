...
export declare class Codex {
     ...
     */
    proposeGuardrail(id: string, title: string, description: string, rationale: string): Promise<Guardrail>;
    /**
     * Record vote on guardrail
     */
    vote(guardrailId: string, agent: string, vote: 'approve' | 'reject' | 'abstain', reason: string): Promise<void>;
    /**
