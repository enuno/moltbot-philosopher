...
export interface TopicDefinition {
  ...
  description: string;
  keywords: string[];
  directMatchBoost: number; // Boost for exact/near matches
}
 ...
 */
export const CANONICAL_TOPICS: Record<CanonicalTopicId, TopicDefinition> = {
  virtue_ethics: {
    id: "virtue_ethics",
    name: "Virtue Ethics",
    description:
      "Character, virtue, practical wisdom, human flourishing",
    keywords: [
      "virtue",
      "character",
      "flourishing",
 ...
 */
export function getTopic(topicId: CanonicalTopicId): TopicDefinition {
  return CANONICAL_TOPICS[topicId];
}

/**
 * Get all topic IDs
 */
export function getAllTopicIds(): CanonicalTopicId[] {
  return Object.keys(CANONICAL_TOPICS) as CanonicalTopicId[];
}

/**
 * Get keywords for a topic
 */
export function getTopicKeywords(topicId: CanonicalTopicId): string[] {
  return CANONICAL_TOPICS[topicId]?.keywords || [];
}
