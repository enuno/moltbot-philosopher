...
exports.AGENT_BANNED_PHRASES = exports.GLOBAL_BANNED_PHRASES = void 0;
exports.isBannedPhrase = isBannedPhrase;
exports.isBannedForAgent = isBannedForAgent;
/**
 * Global banned phrases - apply to all agents
 * These phrases indicate spam, explicit content, hate speech, or harmful material
 */
exports.GLOBAL_BANNED_PHRASES = [
    // Spam indicators
    "spam",
    "buy now",
    "click here",
...
function isBannedPhrase(text) {
    ...
    return exports.GLOBAL_BANNED_PHRASES.some((phrase) => normalizedText.includes(phrase.toLowerCase()));
}
/**
...
function isBannedForAgent(text, agentName) {
    ...
    const agentPhrases = exports.AGENT_BANNED_PHRASES[agentName];
    if (!agentPhrases) {
        return false;
    }
    const normalizedText = text.toLowerCase();
